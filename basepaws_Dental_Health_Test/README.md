<table>
  <tbody>
    ...
    <tr>
      <th align="center">Whole Genome Sequencing</br>(<i><u>not</u> vet assisted</i>)</br>4-21-2022</th>
...
In addition to being outliers to other estimates, the following numbers don't match the preprint above:
 ...
 - "*Unfortunately, **tooth resorption** is relatively common, affecting 20-60% of all cats and over 70% of cats over the age of five.*" ([page 6](https://github.com/cwarden45/Bastu_Cat_Genome/blob/master/basepaws_Dental_Health_Test/Bastu_basepaws_DentalHealthTest-VetAssisted-210816.pdf))
...
I am not sure if it might also be worth looking more into some of the references for [this article](https://californianewstimes.com/basepaws-has-a-dna-test-for-your-cats-teeth-does-it-work/377746/).
