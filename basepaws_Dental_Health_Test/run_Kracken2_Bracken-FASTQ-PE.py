...
#copied and modified from https://github.com/cwarden45/PRJNA513845-eDNA_reanalysis/blob/master/metagenomics/run_Kracken2_Bracken-FASTQ-PE.py

finishedSamples = [""]
inputFolder = "."
outputFolder = "Kraken2_Bracken"
suffix = "_1.fastq.gz"
...
for file in fileResults:
	...
	if result:
		...
		if sample not in finishedSamples:
			...
			read2 = re.sub("_1.fastq.gz","_2.fastq.gz",read1)
