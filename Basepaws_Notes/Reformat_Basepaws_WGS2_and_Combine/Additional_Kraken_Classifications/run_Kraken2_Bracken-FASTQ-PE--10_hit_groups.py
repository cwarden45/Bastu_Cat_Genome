...
outputFolder = "../Kraken-OUT-minikraken_8GB_20200312-10_hit_groups"
suffix = "_R1.fastq.gz"
...
for file in fileResults:
	...
	if result:
		...
		if sample not in finishedSamples:
			...
			command = "/opt/kraken2/kraken2 --minimum-hit-groups 10 --paired --db "+ref+" --output "+outputFile+" --report "+reportFile+" "+read1+" "+read2
			os.system(command)
