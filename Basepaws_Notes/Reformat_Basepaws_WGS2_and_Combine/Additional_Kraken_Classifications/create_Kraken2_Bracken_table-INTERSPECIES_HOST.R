...
output.classification_rate = "n29_k2_standard_20221209-Bracken-Bacterial_Classifications-DOWNSAMPLE.txt"
output.percent_quantified = "n29_k2_standard_20221209-FILTERED_Bracken_genera-heatmap_quantified-DOWNSAMPLE.txt"
output.counts = "n29_k2_standard_20221209-FILTERED_Bracken_genera-counts-DOWNSAMPLE.txt"
heatmap.output_quantified = "n29_k2_standard_20221209-FILTERED_Bracken_genera-heatmap_quantified-DOWNSAMPLE.png"
heatmap.output_quantified20 = "n29_k2_standard_20221209-FILTERED_Bracken_genera-heatmap_quantified-TOP20-DOWNSAMPLE.png"
min.percent = 0.5
...
Bracken_files = list.files(input_folder,"_Kraken2_bracken.kreport")#MODIFIED CODE
for (i in 1:length(Bracken_files)){
