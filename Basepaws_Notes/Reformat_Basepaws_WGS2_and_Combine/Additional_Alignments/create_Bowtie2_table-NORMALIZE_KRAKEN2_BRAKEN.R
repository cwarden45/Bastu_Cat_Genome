input_folder = "Bowtie2_Bacteria11_Alignment"
...
output.percent_quantified = "n6_Oral_Bowtie2-heatmap_quantified.txt"
output.counts = "n6_Oral_Bowtie2-counts_raw.txt"
output.percent = "n6_Oral_Bowtie2-percent-external_normalized.txt"
heatmap.output = "n6_Oral_Bowtie2-heatmap.pdf"
...
heatmap.3(genus_percent,   distfun = dist, hclustfun = hclust,
