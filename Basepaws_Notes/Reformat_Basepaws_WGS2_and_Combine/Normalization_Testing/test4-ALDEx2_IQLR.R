...
output.percent_quantified = "test4-n8_Oral_Kraken2_Braken-ALDEx2_IQLR.txt"
dot_plot.output = "test4-n8_Oral_Kraken2_Braken-ALDEx2_IQLR-Staphylococcus.png"
heatmap.output = "test4-n8_Oral_Kraken2_Braken-ALDEx2_IQLR-heatmap_n11.png"
...
plot(as.numeric(as.factor(Samples)), as.numeric(norm_table[rownames(norm_table)=="Streptococcus",]),
		...
		xlab="", ylab="ALDEX Median CLR-IQLR (Streptococcus)", pch=16, col=speciesCol,
		cex=1.2, main="")
