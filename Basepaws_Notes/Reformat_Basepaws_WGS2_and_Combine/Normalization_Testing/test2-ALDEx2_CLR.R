...
output.percent_quantified = "test2-n8_Oral_Kraken2_Braken-ALDEx2_CLR.txt"
dot_plot.output = "test2-n8_Oral_Kraken2_Braken-ALDEx2_CLR-Staphylococcus.png"
heatmap.output = "test2-n8_Oral_Kraken2_Braken-ALDEx2_CLR-heatmap_n11.png"
...
ALDEx2_object = aldex.clr(oral_table, paste(Species,SampleSite,sep=""), denom="all")
...
plot(as.numeric(as.factor(Samples)), as.numeric(norm_table[rownames(norm_table)=="Streptococcus",]),
		...
		xlab="", ylab="ALDEX Median CLR-mean (Streptococcus)", pch=16, col=speciesCol,
		cex=1.2, main="")
