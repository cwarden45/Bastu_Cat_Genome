...
Species   = c("Cat" ,"Cat" ,"Cat" ,"Cat" ,"Cat" ,"Human","Human","Human","Human")
SampleSite= c("Oral","Oral","Oral","Oral","Oral","Oral" ,"Oral" ,"Oral", "Oral")
output.classification_rate = "Oral6SUB3_Kraken2-Bacterial_Classifications.txt"
output.percent_quantified = "Oral6SUB3_FILTERED_Braken_genera-heatmap_quantified.txt"
output.counts = "Oral6SUB3_FILTERED_Braken_genera-counts.txt"
heatmap.output_quantified = "Oral6SUB3_FILTERED_Braken_genera-heatmap_quantified.pdf"
heatmap.output_quantified20 = "Oral6SUB3_FILTERED_Braken_genera-heatmap_quantified-TOP20.pdf"
min.percent = 0.5
