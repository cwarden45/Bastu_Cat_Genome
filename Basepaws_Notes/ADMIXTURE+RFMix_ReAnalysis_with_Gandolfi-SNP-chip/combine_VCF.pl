...
my $VCF_Individual = "HCWGS0003.g.vcf";
my $VCF_prev = "Gandolfi_felCat9.vcf";
my $VCF_Combined = "Gandolfi_felCat9_plus_Bastu.vcf";
my $prev_ped = "Gandolfi_felCat9.ped";
my $updated_ped = "Gandolfi_felCat9_plus_Bastu.ped";
my $GATK4_flag = 1;
my $large_flag = 1;
