...
universal.file = "Illumina_Universal_Adapter-percentages.txt"
nextera.file = "Nextera_Transposase_Sequence-percentages.txt"
small3.file = "Illumina_Small_RNA_3prime_Adapter-percentages.txt"
small5.file = "Illumina_Small_RNA_5prime_Adapter-percentages.txt"
solid.file = "SOLID_Small_RNA_Adapter-percentages.txt"
...
png("FastQC_Universal_Adapter_Results.png", height=400, width=1200)
par(mfrow=c(1,2))
#R1
...
for (i in 1:ncol(MiSeq_R1.mat)){
	points(universal_pos,log10(MiSeq_R1.mat[,i]),
			col=rgb(0, 0, 0, alpha = 0.2),pch=16)
...
for (i in 1:ncol(NovaSeq_R1.mat)){
	points(universal_pos,log10(NovaSeq_R1.mat[,i]),
				col=rgb(1, 0.5, 0, alpha = 0.2),pch=16)
...
png("FastQC_Nextera_Adapter_Results.png", height=400, width=1200)
par(mfrow=c(1,2))
#R1
...
png("FastQC_Small_RNA_3prime_Results.png", height=400, width=1200)
par(mfrow=c(1,2))
#R1
...
png("FastQC_Small_RNA_5prime_Results.png", height=400, width=1200)
par(mfrow=c(1,2))
#R1
...
png("FastQC_SOLiD_Adapter_Results.png", height=400, width=1200)
par(mfrow=c(1,2))
#R1
