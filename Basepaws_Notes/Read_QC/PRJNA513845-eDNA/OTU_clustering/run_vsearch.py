...
command = "/opt/vsearch-2.15.1/bin/vsearch --cluster_smallmem --usersort "+inputFA+" --id 0.97 --centroids "+OTUfa+" --uc "+OTUinfo
#os.system(command)

#--cluster_unoise
OTUfa = "FLASH_combined_VSEARCH_unoise.fa"
OTUinfo = "FLASH_combined_VSEARCH_unoise.txt"
command = "/opt/vsearch-2.15.1/bin/vsearch --cluster_unoisef "+inputFA+" --id 0.97 --centroids "+OTUfa+" --uc "+OTUinfo
os.system(command)
