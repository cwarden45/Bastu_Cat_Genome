...
/opt/ncbi-blast-2.11.0+/bin/blastn -num_threads 4 -task megablast -use_index true -db $REF -query $INFA -out $OUTHITS -evalue 1e-05 -max_target_seqs 1 -outfmt "6 qseqid sseqid evalue bitscore length pident frames staxids sskingdoms sscinames scomnames sblastnames stitle qseq qstart qend"