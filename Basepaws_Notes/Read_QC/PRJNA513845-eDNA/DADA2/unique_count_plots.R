...
#meta.file =  "Cutadapt-filtered_read_counts-with_sequencer_and_FLASHcounts.txt"

seqType = "PEAR_merged"
meta.file =  "Cutadapt-filtered_read_counts-with_sequencer_and_FLASHplusPEAR_counts.txt"
